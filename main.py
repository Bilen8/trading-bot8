...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in ['daily_quotes', 'next_quote']:
        ...
        media = [InputMediaPhoto(url) for url in RESULT_IMAGES]
        ...
        await query.edit_message_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🌍 PocketOption", url="https://u3.shortink.io/register?…")],
                [InlineKeyboardButton("🇷🇺 PocketOption Russia", url="https://po-ru4.click/register?…")],
